...
public class SplashScreen implements Screen {
    ...
    public SplashScreen(SpaceRace game) {
        ...
        // Afegim el fons
        stage.addActor(new Image(AssetManager.regionsMov));

        // Creem l'estil de l'etiqueta i l'etiqueta
        textStyle = new Label.LabelStyle(AssetManager.font, null);
        textLbl = new Label("Wizard Runs", textStyle);
        ...
        //TODO Exercici 2.1 Apareix i desaparaix el titol mentres s'escala
        container.addAction(Actions.repeat(RepeatAction.FOREVER, Actions.sequence(Actions.scaleTo(1.5f, 1.5f, 1),Actions.alpha(1), Actions.scaleTo(1, 1, 1),Actions.alpha(0))));

        stage.addActor(container);

        // Creem la imatge de la nau i li assignem el moviment en horitzontal
        Image spacecraft = new Image(AssetManager.wizardRR);
