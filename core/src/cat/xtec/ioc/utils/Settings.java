...
public class Settings {
    ...
    // TODO Exercici 3.1- Propietats per la moneda
    public static final int SCORE_SPEED50 = -250;
    public static final int SCORE_SPEED10 = -175;
    public static final float MAX_MONEDES = 0.9f;
    public static final float MIN_MONEDES = 0.5f;
